...
export const skillCategories: SkillCategory[] = [
  ...
  { title: "Firebase", icon: "🔥", skills: ["Firebase Analytics", "Firebase Crashlytics", "Firebase Cloud Messaging (FCM)", "Push Notifications"] },
  ...
  { title: "DevOps & Tools", icon: "⚙️", skills: ["Git", "CI/CD", "Continuous Integration", "Continuous Deployment", "App Store Deployment", "Google Play", "Huawei AppGallery"] },
